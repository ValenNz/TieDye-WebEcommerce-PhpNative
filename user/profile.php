                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          //  echo "<label class='alert alert-secondary'>".$data_pembelian['status']."</label>";
                          // } else if ($data_pembelian['status'] = "confirm"){
                          //   echo "<label class='alert alert-primary'>".$data_pembelian['status']."</label>";
                          // }
                          ?>
                        </td>                                                
                    </tr>
