                    ...
                    <tbody>
                        <?php
                            ...
                            if (isset($_POST["cari"])) {
                                ...
                                $cari=$_POST['cari'];
                                $query_pelanggan= mysqli_query($conn,"SELECT * FROM pelanggan WHERE id_pelanggan LIKE '%$cari%' OR nama_pelanggan LIKE '%$cari%' OR username LIKE '%$cari%' OR alamat LIKE '%$cari%'");
                            }else{
