...
<?php
include "login_check.php"; // Memeriksa status login
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class='card-body'>
            <table class="table table-bordered fs-5 fw-light text-center">
                ...
                if (isset($_POST["cari"])) {
                    ...
                    $cari=$_POST['cari'];
                    $query_transaksi= mysqli_query($conn,"select * from transaksi where id_transaksi like '%$cari%' or id_pelanggan like '%$cari%' or tgl_transaksi like '%$cari%'");
                }else{
                ...
                while($data_transaksi= mysqli_fetch_array($query_transaksi)) {
                    ...
                    <tr>
                        ...
                        <td><img src="../admin/img/<?=$data_transaksi['foto_produk']?>" class="img-fluid rounded-start" width="150px" height="150px" alt="..." ></td>
